          ...
          >
            ...
            <div className="flex flex-wrap items-center gap-4">
              ...
              <div className="bg-white/10 backdrop-blur-md border border-white/20 px-6 py-4 rounded-2xl text-lg font-extrabold">
                450,000원 <span className="text-xs font-normal text-white/70">/ 1회차 기준 (전과정 5회차 + 1개월 케어)</span>
              </div>
            </div>
          </motion.div>
        </div>
        ...
        <section>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="bg-white p-6 rounded-2xl border border-black/5 shadow-sm">
              ...
              <p className="font-bold text-sm md:text-base text-brand-primary">450,000원 (1회차 기준)</p>
            </div>
          </div>
        </section>
