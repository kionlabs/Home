          ...
          >
            ...
            <div className="flex flex-wrap items-center gap-4">
              ...
              <div className="bg-white/10 backdrop-blur-md border border-white/20 px-6 py-4 rounded-2xl text-lg font-extrabold">
                990,000원부터 <span className="text-xs font-normal text-white/70">/ 상담 후 범위 조율</span>
              </div>
            </div>
          </motion.div>
        </div>
        ...
        <section>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="bg-white p-6 rounded-2xl border border-black/5 shadow-sm">
              ...
              <p className="font-bold text-sm md:text-base text-brand-primary">990,000원부터 (상담 후 견적)</p>
            </div>
          </div>
        </section>
